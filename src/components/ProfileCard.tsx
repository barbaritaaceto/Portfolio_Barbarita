      ...
      <Card className="w-full max-w-2xl text-center p-6 md:p-8">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full justify-center mt-2">
            ...
            <a href="mailto:aceto.barbara@gmail.com"><Button variant="ghost" className="rounded-full px-5 py-2 border-[var(--card-border)]" style={{borderColor:'var(--primary)'}}>Get in touch</Button></a>
            <a href="/One%20Sheet%20Aceto%20Barbara.png" download="CV - Aceto Barbara.png" className="self-center text-sm text-gray-600 underline">Download CV</a>
          </div>
        </div>
      </Card>
    </div>
