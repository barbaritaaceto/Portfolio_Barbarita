...
const learnings: Record<string, { es: string; en: string }> = {
  ...
  'santander-argentina': {
    ...
    en: 'Products are not built by methodologies or technology alone — they are built by people. Enjoying what you do, sharing knowledge, spreading energy and working with a clear purpose makes all the difference. But for a product to truly grow, you also need aligned teams, transparent communication, trust and a healthy environment where people can build and fail without fear. That is where the products that really leave a mark come from.',
  },
  'mercado-libre': {
    es: 'Los equipos de alto rendimiento realmente existen. Las metodologías ágiles funcionan cuando hay confianza, autonomía y personas comprometidas detrás. Se puede construir, iterar y salir a producción disfrutando el proceso. También entendí que la relación entre Producto y Tecnología es una de las claves más importantes para que un lanzamiento sea exitoso. Y, sobre todo, que los compañeros de trabajo pueden transformarse en amigos. Eternamente agradecida a mi equipo: "Gente Bella". 💛',
    en: 'High-performance teams really do exist. Agile methodologies work when there is trust, autonomy and committed people behind them. You can build, iterate and ship to production while actually enjoying the process. I also understood that the relationship between Product and Technology is one of the most important keys to a successful launch. And above all, that teammates can become friends. Eternally grateful to my team: "Gente Bella". 💛',
  },
  '123seguro': {
    es: 'Que Growth no es solo adquisición: es entender por qué una persona se queda, por qué se va y cómo generar valor de forma constante. Descubrí que la experimentación cambia completamente la manera de tomar decisiones, haciendo que la intuición y los datos trabajen juntos.\n\nTambién fue la primera vez que trabajé tan cerca de áreas muy distintas entre sí — Comunicación, RRHH, IT, Call Center y Ventas — y fue un privilegio poder conocer las realidades de tantos profesionales diferentes. Esa experiencia me ayudó a ampliar mi mirada, desarrollar empatía y entender mejor cómo optimizar mi trabajo para generar impacto real más allá del producto.',
    en: 'Growth is not just acquisition: it is understanding why a person stays, why they leave and how to generate value consistently. I discovered that experimentation completely changes the way decisions are made, making intuition and data work together.\n\nIt was also the first time I worked so closely with very different areas — Communications, HR, IT, Call Center and Sales — and it was a privilege to get to know the realities of so many different professionals. That experience helped me broaden my perspective, develop empathy and better understand how to optimize my work to generate real impact beyond the product.',
  },
  'cognizant': {
    es: 'Trabajar con clientes de industrias muy distintas me enseñó a contextualizar rápido y a priorizar incluso con información incompleta. Entendí que esa es una de las habilidades más importantes en producto. Pero también descubrí el otro extremo: qué hacer cuando los datos sí existen… y existen de sobra. Aprender a entender al usuario, interpretar su comportamiento, detectar necesidades y proyectar posibles decisiones futuras me abrió un mundo completamente nuevo. Ahí fue donde entendí que la data no vale por cantidad, sino por el propósito con el que se usa.',
    en: 'Working with clients from very different industries taught me to contextualize quickly and prioritize even with incomplete information. I understood that this is one of the most important skills in product. But I also discovered the other extreme: what to do when data does exist — and exists in abundance. Learning to understand the user, interpret their behavior, detect needs and project possible future decisions opened up a completely new world for me. That is where I understood that data is not valuable for its quantity, but for the purpose with which it is used.',
  },
  'globant': {
    es: 'A veces los cambios más pequeños son los que generan el mayor impacto para las personas. SEO fue mi primer contacto real entre datos y comportamiento de usuario, y ahí nació mi curiosidad por producto: entender cómo la gente busca, decide y reacciona. También descubrí que detrás de cada métrica que se dispara hay decisiones, contexto y necesidades humanas. Fue la primera vez que sentí que existía un mundo enorme allá afuera esperándome, y que con los años iba a encontrar mi lugar dentro de él.',
    en: 'Sometimes the smallest changes generate the greatest impact for people. SEO was my first real contact between data and user behavior, and that is where my curiosity for product was born: understanding how people search, decide and react. I also discovered that behind every metric that spikes there are decisions, context and human needs. It was the first time I felt there was a huge world out there waiting for me, and that over the years I would find my place within it.',
  },
...
export default function Projects() {
  ...
  const esMap: Record<string, string> = {
    'redbee': 'redbee',
    'Challenging myself professionally in building a corporate home banking, creating with AI, product and team processes.': 'Desafiandome como profesional en la construcción de un home banking empresas, creando con AI, producto y procesos de equipo.',
    ...
    'Started in the Home Banking CORE team, working on key features and processes for corporate digital channels. Then in the Collections & Payments Tribe, I led digitalization initiatives, product strategy and continuous improvement for product acquisition onboarding.': 'Comencé mi camino en el equipo CORE del Home Banking, trabajando en funcionalidades y procesos clave para canales digitales corporativos. Luego en la Tribu de Cobros y Pagos, lideré iniciativas de digitalización, estrategia de producto y mejora continua para el onboarding de adquisición de productos.',
    // Santander roles
    'Product Manager at Collections and Payments Tribe': 'Product Manager en la Tribu de Cobranzas y Pagos',
    'Sr. Product Lead on One Product Team': 'Sr. Product Lead en One Product Team',
    'Aug 2023 - Jul 2025 · 2 yrs': 'Ago 2023 - Jul 2025 · 2 años',
    'Aug 2021 - Aug 2023 · 2 yrs 1 mo': 'Ago 2021 - Ago 2023 · 2 años 1 mes',
    'Defined product vision and roadmap for the Onboarding Squad': 'Definí la visión y el roadmap de producto para el Squad de Onboarding',
    'Led cross-functional teams using agile methodologies (Scrum)': 'Lideré equipos cross-funcionales con metodologías ágiles (Scrum)',
    'Drove end-to-end digitalization of collections and payments onboarding': 'Impulsé la digitalización end-to-end del onboarding de cobranzas y pagos',
    'Collaborated with partners to enable cross-selling and up-selling': 'Colaboré con partners para habilitar cross-selling y up-selling',
    'Built the measurement and analytics strategy': 'Construí la estrategia de medición y analytics',
    'Used data to track performance and optimize continuously': 'Usé datos para trackear performance y optimizar continuamente',
    'Defined and prioritized the product backlog aligned with business goals': 'Definí y prioricé el backlog de producto alineado a los objetivos de negocio',
    'Gathered requirements and insights from key stakeholders and users': 'Relevé requerimientos e insights de stakeholders clave y usuarios',
    'Communicated product vision to IT and cross-functional teams': 'Comuniqué la visión de producto a IT y equipos cross-funcionales',
    'Managed the product roadmap and delivery timelines': 'Gestioné el roadmap de producto y los tiempos de entrega',
    'Facilitated agile ceremonies (sprint planning, reviews, retros, etc.)': 'Facilité ceremonias ágiles (sprint planning, reviews, retros, etc.)',
    'Tracked key metrics and user feedback to drive iterations': 'Trackeé métricas clave y feedback de usuarios para iterar',
    'Aligned strategy with market trends and customer needs': 'Alineé la estrategia con tendencias del mercado y necesidades de clientes',
    // Santander talks
    'Basic concepts of a Product Owner': 'Conceptos básicos de un Product Owner',
    'Metrics and measurement': 'Métricas y medición',
    'Google Analytics and Tarot': 'Google Analytics y Tarot',
    'Basic GA4': 'GA4 básico',
    'Google Tag Manager': 'Google Tag Manager',
    'Google Looker Studio': 'Google Looker Studio',
    'UX basics': 'Bases de UX',
    ...
    'I began my journey in digital marketing within the Classifieds team. I learned the organic positioning mindset, opportunity detection through keyword research and the analytical, bold approach that digital marketing requires.': 'Comencé mi camino en marketing digital dentro del equipo de Clasificados. Aprendí el mindset del posicionamiento orgánico, la detección de oportunidades a través de keyword research y la mirada analítica y audaz que requiere el marketing digital.',
