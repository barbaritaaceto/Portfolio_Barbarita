...
export const intents: AssistantIntent[] = [
  ...
  },
  {
    ...
    responseES: 'Barbara empezó desde el SEO — aprendiendo que los cambios más pequeños pueden tener el impacto más grande en cómo la gente te encuentra. Desde ahí migró a producto, y no paró de crecer.\n\nMás de 10 años construyendo en banca, ecommerce, insurtech y consultoría digital. Lo que la define no es la industria ni los títulos: es la convicción de que los productos los construyen las personas, no las metodologías.\n\nHoy lidera en redbee — combinando AI aplicada a producto con el desafío muy humano de acompañar a cada persona de su equipo a convertirse en su mejor versión.',
    responseEN: "Barbara started in SEO — learning that the smallest changes can have the biggest impact on how people find you. From there, she moved into product, and never stopped growing.\n\n10+ years building in banking, e-commerce, insurtech, and digital consulting. What defines her isn't the industry or the titles — it's the belief that products are built by people, not methodologies.\n\nToday she leads at redbee, combining AI applied to product with the very human challenge of helping each person on her team become their best version.",
    variantsES: [
      'Barbara empezó desde el SEO — aprendiendo que los cambios más pequeños pueden tener el impacto más grande en cómo la gente te encuentra. Desde ahí migró a producto, y no paró de crecer.\n\nMás de 10 años construyendo en banca, ecommerce, insurtech y consultoría digital. Lo que la define no es la industria ni los títulos: es la convicción de que los productos los construyen las personas, no las metodologías.\n\nHoy lidera en redbee — combinando AI aplicada a producto con el desafío muy humano de acompañar a cada persona de su equipo a convertirse en su mejor versión.',
      'Barbara conecta los puntos donde negocio, tecnología y personas suelen hablar idiomas distintos.\n\nMás de 10 años construyendo productos en banca, ecommerce, insurtech y consultoría digital. Hoy lidera en redbee con foco en AI aplicada a producto y equipos.\n\nLo que la define: no acumula features. Crea las condiciones para que los equipos puedan construir en serio.',
    ],
    variantsEN: [
